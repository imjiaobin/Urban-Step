...
export default function BrandAbout() {
  return (
    <>
      <section className={`col-10 col-md-4 mb-48 mb-md-32`}>
        <div className={` ${styles.about}`}>
          <img className="mb-24 mb-md-16" src={aboutImage} alt="" />

          <div className={styles.textContent}>
            <h4 className="h4 mb-24">品牌簡介</h4>
            <p className="h5 mb-16 mb-md-12 text-primary-400">
              URBANSTEP
              是來自台灣的街頭機能鞋品牌，致力於打造「風格與功能並存」的鞋履體驗。
            </p>
            <p className="mb-16 mb-md-12">
            ...
            <p className="mb-48 mb-md-32">
              URBANSTEP 的名字來自 Urban +
